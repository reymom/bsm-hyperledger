...
func checkForHigherBid(ctx contractapi.TransactionContextInterface, auctionPrice uint, revealedBidders map[string]FullBid, bidders map[string]BidHash) error {
